...
export function randomColourFromPalette() {
 ...
 */
export function minByOrThrow(inputArray, iterateeFn) {
...
export function collect(numItems, fn) {
    const arr = [];
...
export function drawDebugText(world) {
...
//# sourceMappingURL=randomStuff.js.map
